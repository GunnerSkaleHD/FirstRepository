...
const array: string[] = [
    'Daenerys Targaryen', 'Samwell Tarly',     'Jon Snow',
    'Arya Stark',         'Sansa Stark',       'Brandon Stark',
    'Ned Stark',          'Robert Baratheon',  'Jamie Lannister',
    'Cersei Lannister',   'Catelyn Stark',     'Rob Stark',
    'Theon Greyjoy',      'Joffrey Baratheon', 'Tyrion Lannister',
    'The Hound',          'Petyr Baelish',     'Davos Seaworth',
    'Stannis Baratheon',  'Varys',             'Khal Drogo',
    'Margaery Tyrell',    'Ygritte',           'Brienne of Tarth',
    'Missandei',          'Gilly',             'Viserys Targaryn',
    'Rickon Stark',       'Roose Bolton',      'Daario',
    'Shae',               'Tommen Baratheon',  'Gendry Baratheon',
    'Jorah Mormont',      'Robert Baratheon',  'Ramsey Bolton',
    'Talisa Stark',       'Jeor Mormont',      'The High Sparrow',
    'Oberyn Martell',     'Melisandre',        "Jaqen H'ghar",
    'Tywin Lannister',    'Ellaria Sand',      'Tormund Giantsbane',
    'Yara Greyjoy',       'Euron Greyjoy',     'Hodor',
    'Pycelle',            'Grey Worm',         'Olenna Tyrell',
    'Qyburn',             'Lord Bronn'
]

describe(CharactersList, () => {
    it("Should display 5 Characters from the Array of Characters", () => {
        const { getByTestId } = render(<CharactersList characters={data} />)
        const characterValue = getByTestId("characterName").textContent;
        expect(characterValue).toBeIn(array)
    });
});
