...
const characters: Character[] = [
    {
        ...
        image: "",
        imageUrl:
            "https://m.media-amazon.com/images/I/61X1QDPTE1L._AC_SX679_.jpg",
    },
    {
        id: 1,
        firstName: "Steve",
    ...
    },
    {
        ...
        image: "",
        imageUrl:
            "https://superhelden.org/wp-content/uploads/2023/01/Ant-Man.jpg",
    },
    {
        id: 8,
        firstName: "Thanos",
...
app.get("/mcuAPI", (req: Request, res: Response) => {
    const generateRandomImages = (
        ...
        let shuffledCharacters = [...characters].sort(
            () => Math.random() - 0.5
        );
